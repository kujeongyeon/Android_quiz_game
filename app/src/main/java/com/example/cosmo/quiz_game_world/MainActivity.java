package com.example.cosmo.quiz_game_world;
...
import com.example.cosmo.quiz_game_world.Model.User;
                ...
                users.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        if(dataSnapshot.child(user.getUserName()).exists())
                            Toast.makeText(MainActivity.this, "User already existe !", Toast.LENGTH_SHORT).show();
                        else
                        {
